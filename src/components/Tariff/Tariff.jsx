        ...
        <section className="checkout__tariff tariff">
            ...
            <div className="tariff__variants">
                {tariffTypes.map(tariff => {
                    return (
                        <div onClick={() => setTariff(tariff.id)} className={"tariff__variant tariff-variant" + (tariff.selected ? ' tariff-variant_active' : '')}>
                            <div className="tariff-variant__item">
                                ...
                                <div className="tariff-variant__description">
                                    <div className="tariff-variant__text">{tariff.text}</div>
