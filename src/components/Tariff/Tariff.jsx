    ...
    return (
        <section className="checkout__tariff tariff">
            ...
            <div className="tariff__variants">
                    ...
                    <div className="tariff-variant__item">
                        ...
                        <div className="tariff-variant__description">
                            <div className="tariff-variant__text">
                                Планир. <span className="tariff-variant__bold">3000 р</span> (437р - час 4 часа работы + час подачи + + )
                            </div>
                ...
                <div className="tariff__variant tariff-variant tariff-variant_active">
                    <div className="tariff-variant__item">
                        <div className="tariff-variant__heading">
                            Ставка -
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="tariff-variant__description">
                            <div className="tariff-variant__text">3000 р<span className="tariff-variant__bold"></span></div>
                            <label className="tariff-variant__check check-wrap">
                    ...
                    <div className="tariff-variant__item">
                        ...
                        <div className="tariff-variant__description">
                            <div className="tariff-variant__text">2800<span className="tariff-variant__bold"></span></div>
                            <label className="tariff-variant__check check-wrap">
                                <input type="checkbox" className="check-wrap__input"/>
                                <span className="check-wrap__mark"></span>
                            </label>
                ...
                <div className="tariff__variant tariff-variant">
                    <div className="tariff-variant__item">
                        ...
                        <div className="tariff-variant__description">
                            <div className="tariff-variant__text">
                                доставка <span className="tariff-variant__bold">2000 р</span> (условия) (для тарифа доставка нужно внести данные по грузу)
                            </div>
                            <label className="tariff-variant__check check-wrap">
                                <input type="checkbox" className="check-wrap__input"/>
                                <span className="check-wrap__mark"></span>
            ...
            <div className="tariff__chosen">
                <div className="tariff__chosen-info">
                    ...
                    <table className="chosen__table">
                        <tr className="chosen__row">
                            ...
                            <td className="chosen__col">
                                <span className="chosen__name">4+1 стоим., часа</span>
                                <span className="chosen__value">100 р.с.ндс</span>
                            </td>
                        </tr>
                        <tr className="chosen__row">
                            <td className="chosen__col">
                            ...
                            <td className="chosen__col">
                                <span className="chosen__name">5часов | стоимость</span>
                                <span className="chosen__value">500 р.с.ндс</span>
                            </td>
                        </tr>
                        <tr className="chosen__row">
                            <td className="chosen__col">
                            ...
                            <td className="chosen__col">
                                <span className="chosen__name">7ч.30м | стоимость</span>
                                <span className="chosen__value">3750 р.с.ндс</span>
                            </td>
                        </tr>
                        <tr className="chosen__row">
                            <td className="chosen__col">
                            ...
                            <td className="chosen__col">
                                <span className="chosen__name">4+1 стоим., часа</span>
                                <span className="chosen__value">35 р</span>
                            </td>
                        </tr>
                    </table>
                ...
                <div className="tariff__map"><img src={require("../../img/checkout/tariff/map.jpg")} alt="Map"/></div>
            </div>
        </section>
    );
}
