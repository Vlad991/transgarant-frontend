                        ...
                        <div className="tariff-variant__heading">
                            ...
                            <div className="tariff__info-icon info-icon">
                                ...
                                <div className="info-icon__text">
                                    <a target="_blank" rel="noopener noreferrer" href="https://docs.google.com/document/d/1qm0OF9PcSZZcGHvP0e_hkHf7NqI9VGN67PbCKFohpgg/edit">Условия работы и договор >></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div onClick={() => setTariff(state.tariff_types[2].id)} className="tariff-variant__item">
                        <div className="tariff-variant__heading">
                            ...
                            <div className="tariff__info-icon info-icon">
                                ...
                                <div className="info-icon__text">
                                    <a target="_blank" rel="noopener noreferrer" href="https://docs.google.com/document/d/19kwRryD9MBkDZmNNklgo2eQHKL2Lj8HGUB5JMnXkY7U/edit">Условия работы и договор >></a>
                                </div>
                            </div>
                        </div>
                        <div className="tariff-variant__description">
                            ...
                            <label className="tariff-variant__check check-wrap">
                                {state.tariff_types[2].id === state.selected_tariff ?
                                    <input key={1} type="checkbox" name="payment" checked onChange={() => {
                                    }} className="check-wrap__input"/> :
                                    <input key={2} type="checkbox" name="payment" onChange={() => {
                                    }} className="check-wrap__input"/>}
                                <span className="check-wrap__mark"></span>
                            </label>
                        </div>
                        ...
                        <div className="tariff-variant__description">
                            ...
                            <label className="tariff-variant__check check-wrap">
                                {state.tariff_types[3].id === state.selected_tariff ?
                                    <input key={1} type="checkbox" checked onChange={() => {
                                    }} name="payment" className="check-wrap__input"/> :
                                    <input key={2} type="checkbox" onChange={() => {
                                    }} name="payment" className="check-wrap__input"/>}
                                <span className="check-wrap__mark"></span>
                            </label>
