...
const Route = ({dateFrom,
    ...
    return (
        <section className="checkout__route route">
                ...
                {points.map(point => {
                    return (
                        <div className="route__point route-point">
                            ...
                            <div className="route-point__contact">{point.contact}</div>
                            <div className="route-point__footer">
                                <div className="route-point__text">Принять гурз для того то от такой то компании сказать что по счету такому то</div>
            ...
            <div className="route__add-button button-rhomb"><span className="button-rhomb__text">Добавить адрес</span></div>
            <div className="route__add-form add-form">
                <div className="add-form__col add-form__col_first">
                    <div className="add-form__heading">Точка 1</div>
                    <label className="add-form__address input-wrap">
                        <input type="text" className="input-wrap__input" placeholder="Адрес"/>
                    </label>
                    <div className="add-form__inputs">
                        <label className="add-form__input input-wrap">
                            <input type="text" className="input-wrap__input" placeholder="Комментарий к адресу"/>
                        </label>
                        <label className="add-form__input input-wrap">
                            <input type="text" className="input-wrap__input" placeholder="В какую компанию по адресу"/>
                        </label>
                        <label className="add-form__input input-wrap">
                            <input type="text" className="input-wrap__input" placeholder="Контактное лицо (ФИО)"/>
                        </label>
                        <label className="add-form__input input-wrap">
                            <input type="text" className="input-wrap__input" placeholder="Номер телефона"/>
                        </label>
                        <label className="add-form__input input-wrap">
                            <input type="text" className="input-wrap__input" placeholder="Что нужно сделать по адресу"/>
                        </label>
                        <label className="add-form__input add-form__input_file input-wrap">
                            ...
                            <input type="file" className="input-wrap__input" placeholder="Прикрепить файл"/>
                        </label>
                    </div>
                </div>
                <div className="add-form__col add-form__col_second">
                    ...
                    <div className="add-form__time">
                        <label className="add-form__time-item input-wrap">
                            <input type="text" className="input-wrap__input" placeholder="c __.__" value="с 09.00"/>
                        </label>
                        <label className="add-form__time-item input-wrap">
                            <input type="text" className="input-wrap__input" placeholder="до __.__" value="до 18.00"/>
                        </label>
                    </div>
            ...
            <div className="route__add-button button-rhomb"><span className="button-rhomb__text">Добавить</span></div>
        </section>
    );
}
