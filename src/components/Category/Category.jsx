                ...
                {categories.map(category => {
                    return (
                        <div key={category.id} className={"category__category-item category-item" + (category.id === activeCategory ? ' category-item_active' : '')}
                            ...
                            <div className="category-item__text">от {category.weight_from}кг до {category.weight_to}кг от {category.area_from}м3 до {category.area_to}м3</div>
                            <div className="category-item__info">
                                ...
                                <div className="category-info">
                                    ...
                                    <div className="category-info__col">
                                        <div className="category-info__line">
                                            <div className="category-info__name">Палеты</div>
