...
const Date = ({
    ...
    return (
        <div className={"route__title checkout__title" + (hasError ? ' checkout__has-error' : '')}>
            ...
            <div className="route__calendars">
                <div key={1} className={"route__calendar calendar" + (showFromPicker ? " route__calendar_active" : '')}>
                    <DatePicker
                ...
                <div key={2} className={"route__calendar route__calendar_second calendar" + (showToPicker ? " route__calendar_active" : '')}>
                    <DatePicker
                        onChange={setDateTo}
